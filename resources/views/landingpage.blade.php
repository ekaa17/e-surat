...
<head>
  ...
  <link href="l{{ asset('assets/img/profile/Logo.jpg') }}" rel="apple-touch-icon">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">Company Profil</h1>
      </a>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>PT.INDOKARYA JASA PRIMA</h1>
            <p>Contractor, Trading & Supplier</p>
          </div>
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
            <img src="landing/img/LogoIDKY.png" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p>
              Menjadi perusahaan swasta nasional yang handal dalam bidang perdagangan umum dan sumber daya energi, kontraktor di bidang jasa kontruksi meliputi kontruksi pipa, fabrikasi baja dan pekerjaan sipil dengan ditunjung Total Quality Management yang memberikan Total Quality Services bagi para pengguna jasa di seluruh indonesia.
            </p>
          </div>

          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <li>Memberikan pelayanan ,mutu dan epuasan yang terbaik kepada pelanggan</li>
            <li>Membangun serta menciptakan citra terbaik Perusahaan </li>
            <li>Serta turut berpartisipasi dalam pembangunan negara kesatuan Republik Indonesia.</li>
          </div>
        </div>
      </div>
      <div class="container section-title" data-aos="fade-up">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="d-flex align-items-center">
            <span class="sitename">PT.INDOKARYA JASA PRIMA</span>
          </a>
