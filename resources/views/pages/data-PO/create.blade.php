                    ...
                    <div class="card-body">
                        <form action="{{ route('data-PO.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('purchase_no') is-invalid @enderror" name="purchase_no" value="{{ old('purchase_no') }}" required>
                                    @error('purchase_no')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('Alamat_kirim') is-invalid @enderror" name="alamat_kirim" value="{{ old('alamat_kirim') }}" required>
                                    @error('alamat_kirim')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="0.01" class="form-control @error('harga_satuan') is-invalid @enderror" name="harga_satuan" value="{{ old('harga_satuan') }}" required>
                                    @error('harga_satuan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="0.01" class="form-control @error('jumlah_amount') is-invalid @enderror" name="jumlah_amount" value="{{ old('jumlah_amount') }}" required>
                                    @error('jumlah_amount')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
